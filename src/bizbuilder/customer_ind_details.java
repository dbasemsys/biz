 ...
 * @author THANATOS
 */
public class customer_ind_details extends javax.swing.JFrame {

    /**
     * Creates new form customer_ind_details
     */
    public customer_ind_details() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customer_ind_details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new customer_ind_details().setVisible(true);
            }
        });
    }
